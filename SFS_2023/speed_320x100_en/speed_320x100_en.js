...
(lib.Asset7mobiCCMTear = function() {
	this.initialize(ss["speed_320x100_en_atlas_P_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.speed_320x100_en = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/speed_320x100_en_atlas_P_1.png", id:"speed_320x100_en_atlas_P_1"}
	],
	preloads: []
};
