...
lib.ssMetadata = [
		{name:"jetfam_300x250_us_atlas_P_1", frames: [[0,468,131,130],[133,468,121,121],[256,468,121,121],[0,0,557,466]]}
];
...
(lib.Asset2pngcopy = function() {
	this.initialize(ss["jetfam_300x250_us_atlas_P_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(85.05,-58.775);
	...
	this.shape_1.setTransform(77.5,-58.775);
...
// stage content:
(lib.jetfam_300x250_us = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(161,281.2,1,1,0,0,0,62,18);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/jetfam_300x250_us_atlas_P_1.png", id:"jetfam_300x250_us_atlas_P_1"}
	],
	preloads: []
};
