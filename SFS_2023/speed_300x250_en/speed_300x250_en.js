...
lib.ssMetadata = [
		{name:"speed_300x250_en_atlas_P_1", frames: [[0,0,557,462]]}
];
...
(lib.Asset6tearBB = function() {
	this.initialize(ss["speed_300x250_en_atlas_P_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-9,0,0.5452,0.5452);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.rip, new cjs.Rectangle(-9,0,303.7,251.9), null);
...
// stage content:
(lib.speed_300x250_en = function(mode,startPosition,loop,reversed) {
...
p.nominalBounds = new cjs.Rectangle(-109.6,124,591.3,476);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/speed_300x250_en_atlas_P_1.png", id:"speed_300x250_en_atlas_P_1"}
	],
	preloads: []
};
