...
if (reversed == null) { reversed = false; }
	...
	this.shape_5.setTransform(208.0723,336.0081,0.6681,0.6681);
	...
	this.shape_6.setTransform(186.6944,336.0081,0.6681,0.6681);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AA5CYIAAh9IhxAAIAAB9IhPAAIAAkvIBPAAIAAB1IBxAAIAAh1IBPAAIAAEvg");
	this.shape_7.setTransform(163.0785,336.0248,0.6681,0.6681);
	...
	this.shape_8.setTransform(134.2684,336.0248,0.6681,0.6681);
	...
	this.shape_12.setTransform(249.6257,282.4964,0.6681,0.6681);
	...
	this.shape_13.setTransform(212.8824,282.4296,0.6681,0.6681);
	...
	this.shape_14.setTransform(168.1557,282.9641,0.6681,0.6681);
	...
	this.shape_15.setTransform(120.1055,282.463,0.6681,0.6681);
	...
	this.shape_16.setTransform(75.5793,282.4964,0.6681,0.6681);
	...
	this.shape_17.setTransform(175.0367,146.7299,0.6681,0.6681);
	...
	this.shape_18.setTransform(181.7508,182.9555,0.6681,0.6681);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.logo_en_stacked, new cjs.Rectangle(61.6,100.5,237.00000000000003,246.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231F20").s().p("AALAoIgLgsIgKAsIgaAAIgWhPIAbAAIAJAsIAKgsIAZAAIAKAsIAJgsIAbAAIgWBPg");
	this.shape.setTransform(61.2,-1.175);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231F20").s().p("AgeAeQgMgLAAgTQAAgSAMgLQAMgLASAAQATAAAMALQAMALAAASQAAATgMALQgMALgTAAQgSAAgMgLgAgMgNQgEAFAAAIQAAAIAEAFQAGAFAGAAQAIAAAEgFQAFgFAAgIQAAgIgFgFQgEgFgIAAQgHAAgFAFg");
	this.shape_1.setTransform(51.05,-1.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231F20").s().p("AALAoIgXgsIAAAOIAAAeIgZAAIAAhPIAcAAIAWAsIAAgOIAAgeIAZAAIAABPg");
	this.shape_2.setTransform(42.125,-1.175);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#231F20").s().p("AggAoIAAhPIAiAAQAOAAAIAHQAJAHAAAOQAAANgJAHQgIAGgOAAIgIAAIAAAZgAgGgEIAEAAIAGgBQACgCAAgEQAAgFgCgCQgCgBgEAAIgEAAg");
	this.shape_3.setTransform(32.15,-1.175);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#231F20").s().p("AgeAeQgMgLAAgTQAAgSAMgLQAMgLASAAQATAAAMALQAMALAAASQAAATgMALQgMALgTAAQgSAAgMgLgAgMgNQgEAFAAAIQAAAIAEAFQAFAFAHAAQAHAAAGgFQAEgFAAgIQAAgIgEgFQgGgFgHAAQgHAAgFAFg");
	this.shape_4.setTransform(23.75,-1.175);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#231F20").s().p("AALAoIAAgeIgVAAIAAAeIgaAAIAAhPIAaAAIAAAdIAVAAIAAgdIAaAAIAABPg");
	this.shape_5.setTransform(14.95,-1.175);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#231F20").s().p("AgfAeIALgTQAGAEAGACQAGACACABQAGgBAAgDQAAgDgFgBIgLgEIgLgGQgHgFAAgLQAAgLAJgIQAIgHAOAAQASAAALAKIgKASQgEgDgGgCQgFgCgEgBQgFAAAAAEQAAACAEABIAEACIAGACQAIADAFADQAHAFAAALQAAANgKAIQgJAHgOAAQgQAAgOgLg");
	this.shape_6.setTransform(7.375,-1.15);
...
// stage content:
(lib.toe_336x280_us = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(196.45,262.85,1.12,1.12,0,0,0,62,18);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(156).to({_off:false},0).to({x:166.9},20,cjs.Ease.quartOut).wait(30));
	...
	this.instance_4.setTransform(-180.45,170.45,1.12,1.12);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17).to({_off:false},0).to({x:123.25},22,cjs.Ease.quartOut).wait(74).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(75));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({x:106.15,y:175.6},22,cjs.Ease.quartOut).wait(75).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).to({x:123.25},21,cjs.Ease.quartOut).wait(77).to({startPosition:0},0).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(81));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(5).to({_off:false},0).to({x:106.15},21,cjs.Ease.quartOut).wait(78).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},4).wait(81));
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231F20").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
