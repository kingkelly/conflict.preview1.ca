...
lib.ssMetadata = [
		{name:"speed_300x250_us_atlas_P_1", frames: [[0,0,450,377]]}
];
...
(lib.Asset6tearBB = function() {
	this.initialize(ss["speed_300x250_us_atlas_P_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231F20").s().p("AgeAsIAAhXIA9AAIAAAXIghAAIAAAJIAfAAIAAAWIgfAAIAAAKIAhAAIAAAXg");
	this.shape.setTransform(85.05,-98.775);
	...
	this.shape_1.setTransform(77.5,-98.775);
	...
	this.shape_2.setTransform(67.9,-98.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#231F20").s().p("AAZAsIgBgxIgMAxIgXAAIgMgxIgBAxIgcAAIAFhXIAlAAIAKAvIALgvIAlAAIAFBXg");
	this.shape_3.setTransform(57.225,-98.775);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#231F20").s().p("AAMAsIgagwIABAPIAAAhIgcAAIAAhXIAfAAIAZAwIgBgPIAAghIAcAAIAABXg");
	this.shape_4.setTransform(44.325,-98.775);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#231F20").s().p("AAGAsIgMgdIgEAAIAAAdIgdAAIAAhXIAnAAQAPAAAIAHQAMAHAAAOQAAARgPAJIATAhgAgKgGIAHAAQADAAADgBQACgDAAgEQAAgDgCgDQgDgBgDAAIgHAAg");
	this.shape_5.setTransform(35.75,-98.775);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#231F20").s().p("AAPAsIgDgNIgYAAIgEANIgdAAIAehXIAfAAIAeBXgAAGAKIgGgXIgGAXIAMAAg");
	this.shape_6.setTransform(26.675,-98.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#231F20").s().p("AgfAsIAAhXIA9AAIAAAXIggAAIAAAJIAfAAIAAAWIgfAAIAAAKIAhAAIAAAXg");
	this.shape_7.setTransform(18.65,-98.775);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#231F20").s().p("AgcAsIAAhXIAcAAIAAA/IAdAAIAAAYg");
	this.shape_8.setTransform(11.8,-98.775);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AmpB/QhAAAAAg4IAAiNQAAg4BAAAINUAAQA/AAAAA4IAACNQAAA4g/AAg");
	this.shape_9.setTransform(48.35,-99.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-0.6,-111.7,98,25.400000000000006), null);
...
// stage content:
(lib.speed_300x250_us = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(163,321.2,1,1,0,0,0,62,18);
	...
	this.instance_3.setTransform(84.45,285.9,1,1,0,0,0,62,18);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(145).to({y:264.9},23,cjs.Ease.quartInOut).wait(81).to({y:265.9,alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(76));
	...
	this.instance_11.setTransform(158.8,125.2,1,1,0,0,0,151.8,126.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(253).to({x:338.8},21,cjs.Ease.quartInOut).wait(69));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/speed_300x250_us_atlas_P_1.png", id:"speed_300x250_us_atlas_P_1"}
	],
	preloads: []
};
