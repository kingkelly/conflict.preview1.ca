...
lib.ssMetadata = [
		{name:"fam_300x600_us_atlas_P_1", frames: [[116,0,112,123],[0,0,114,124],[0,126,114,123]]},
		{name:"fam_300x600_us_atlas_NP_1", frames: [[0,0,558,1110]]}
];
...
(lib.Asset1 = function() {
	this.initialize(ss["fam_300x600_us_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.Asset2pngcopy = function() {
	this.initialize(ss["fam_300x600_us_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.fam_300x600_us = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fam_300x600_us_atlas_P_1.png", id:"fam_300x600_us_atlas_P_1"},
		{src:"images/fam_300x600_us_atlas_NP_1.jpg", id:"fam_300x600_us_atlas_NP_1"}
	],
	preloads: []
};
