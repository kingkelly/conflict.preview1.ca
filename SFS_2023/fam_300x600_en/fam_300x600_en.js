...
lib.ssMetadata = [
		{name:"fam_300x600_en_atlas_P_1", frames: [[116,0,112,123],[0,0,114,124],[0,126,114,123]]},
		{name:"fam_300x600_en_atlas_NP_1", frames: [[0,0,558,1110]]}
];
...
(lib.Asset1 = function() {
	this.initialize(ss["fam_300x600_en_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.Asset2pngcopy = function() {
	this.initialize(ss["fam_300x600_en_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(45.85,-117.35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhhBcIAjg8QAQANASAHQATAHALAAQARAAAAgLQgCgIgPgEIgigLQgXgKgLgIQgWgSABghQAAgjAcgXQAZgVAtAAQAzAAAiAdIgdA4QgNgLgRgGQgQgGgMAAQgTAAAAAJQAAAHAQAFIAMAEIARAEQAbAJAOAMQAWASAAAhQAAAngfAYQgbAVgsAAQgxAAgsggg");
	this.shape_1.setTransform(29.6,-125.925);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhWB5IAAjxICqAAIAAA+IhcAAIAAAbIBWAAIAAA9IhWAAIAAAcIBfAAIAAA/g");
	this.shape_2.setTransform(10,-126.025);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg4AAIAAg+IC/AAIAAA+Ig4AAIAACzg");
	this.shape_3.setTransform(-10.1,-126.025);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAqB5IgKgiIhDAAIgJAiIhTAAIBUjxIBXAAIBUDxgAAQAaIgRhAIgSBAIAjAAg");
	this.shape_4.setTransform(-32.175,-126.025);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AATB5IgnhRIgOASIAAA/IhPAAIAAjxIBPAAIAABKIAyhKIBdAAIhPBiIBUCPg");
	this.shape_5.setTransform(-54.925,-126.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhhBcIAjg8QAQANASAHQATAHALAAQARAAAAgLQgCgIgPgEIgigLQgXgKgLgIQgVgSAAghQAAgjAcgXQAYgVAuAAQA0AAAhAdIgeA4QgMgLgRgGQgQgGgMAAQgSAAgBAJQABAHAPAFIANAEIAQAEQAbAJANAMQAXASAAAhQAAAnggAYQgbAVgrAAQgxAAgsggg");
	this.shape_6.setTransform(-78.2,-125.925);
...
p.nominalBounds = new cjs.Rectangle(-90,-143.9,144.2,39);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhTB5IAAjxICnAAIAAA+IhZAAIAAAmIBUAAIAAA9IhUAAIAABQg");
	this.shape.setTransform(80.05,-157.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhdBbQglghAAg6QAAg4AlgiQAkgiA5AAQA6AAAlAiQAkAiAAA4QAAA6gkAhQglAig6AAQg5AAgkgigAglgpQgOAPAAAZQAAAZAOAQQAPAOAWAAQAXAAAOgOQAOgQAAgZQAAgZgOgPQgOgQgXAAQgXAAgOAQg");
	this.shape_1.setTransform(56.075,-157.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgnB5IAAhfIhTiSIBXAAIAjBSIAkhSIBXAAIhUCSIAABfg");
	this.shape_2.setTransform(23.85,-157.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhQB5IAAjxIBPAAIAACwIBRAAIAABBg");
	this.shape_3.setTransform(7,-157.275);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgmB5IAAjxIBNAAIAADxg");
	this.shape_4.setTransform(-8.5,-157.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("ABEB5IgDiKIgfCKIhDAAIgfiKIgECKIhNAAIAOjxIBlAAIAeCDIAfiDIBmAAIANDxg");
	this.shape_5.setTransform(-29.85,-157.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAqB5IgKgiIhDAAIgJAiIhTAAIBUjxIBXAAIBUDxgAAQAaIgRhAIgSBAIAjAAg");
	this.shape_6.setTransform(-57.925,-157.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhTB5IAAjxICnAAIAAA+IhYAAIAAAmIBTAAIAAA9IhTAAIAABQg");
	this.shape_7.setTransform(-77.85,-157.275);
...
p.nominalBounds = new cjs.Rectangle(-90,-175.2,181.4,39);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(219.3,-84.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhWB5IAAjxICqAAIAAA+IhcAAIAAAbIBWAAIAAA9IhWAAIAAAcIBfAAIAAA/g");
	this.shape_1.setTransform(203.4,-93.325);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhFBcQgmghAAg7QAAg5AmghQAkgiA3AAQAgAAAUAIQAPAGAKAHIAEACIgWBDIgHgGQgDgDgRgGQgOgGgNAAQgZAAgOAOQgPAOAAAbQAAAYAQAPQAOAOAYAAQAkAAAWgWIAWA/QgeAfg3AAQg3AAgkghg");
	this.shape_2.setTransform(182.15,-93.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgnB5IAAjxIBOAAIAADxg");
	this.shape_3.setTransform(165,-93.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AATB5IgmhRIgKAAIAABRIhPAAIAAjxIBpAAQAsAAAZASQAdAVAAAmQAAAwgoAYIA2BcgAgegSIAUAAQAMAAAFgEQAJgHAAgKQAAgLgJgGQgGgEgLAAIgUAAg");
	this.shape_4.setTransform(148.875,-93.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhjB5IAAjxIBoAAQAsAAAXAUQAcAVAAAqQAAAqgcAVQgXAUgsAAIgZAAIAABLgAgUgNIANAAQAMAAAGgEQAJgGAAgOQAAgNgJgGQgGgEgMAAIgNAAg");
	this.shape_5.setTransform(126.075,-93.325);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg5AAIAAg+IDBAAIAAA+Ig6AAIAACzg");
	this.shape_6.setTransform(97.95,-93.325);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAhB5IAAhZIhBAAIAABZIhPAAIAAjxIBPAAIAABYIBBAAIAAhYIBPAAIAADxg");
	this.shape_7.setTransform(75.35,-93.325);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhQBeQgngiAAg8QAAg8AogiQAjgeA1AAQAqAAAfATQANAHAQARIg0ArQgWgVgcAAQgUAAgPAQQgNAQAAAbQAAAbANARQAPAPAUAAQAZAAAHgGIACgDIAAgRIglAAIAAg6IByAAIAABpIgOAMIgQALQgKAHgKAEQgbALgjAAQg0AAgkgfg");
	this.shape_8.setTransform(49.2,-93.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgnB5IAAjxIBOAAIAADxg");
	this.shape_9.setTransform(30.8,-93.325);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AATB5IgmhRIgKAAIAABRIhPAAIAAjxIBpAAQAsAAAZASQAdAVAAAmQAAAwgoAYIA2BcgAgegSIAUAAQAMAAAFgEQAJgHAAgKQAAgLgJgGQgGgEgLAAIgUAAg");
	this.shape_10.setTransform(14.675,-93.325);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Ctext4, new cjs.Rectangle(0,-111.2,227.7,39), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhWB5IAAjxICqAAIAAA+IhcAAIAAAbIBWAAIAAA9IhWAAIAAAcIBfAAIAAA/g");
	this.shape.setTransform(133.9,-124.575);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAhB5IAAhZIhBAAIAABZIhPAAIAAjxIBPAAIAABYIBBAAIAAhYIBPAAIAADxg");
	this.shape_1.setTransform(110.45,-124.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg5AAIAAg+IDBAAIAAA+Ig5AAIAACzg");
	this.shape_2.setTransform(87.9,-124.575);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AATB5IgmhRIgKAAIAABRIhPAAIAAjxIBpAAQAsAAAZASQAdAVAAAmQAAAwgoAYIA2BcgAgegSIAUAAQAMAAAFgEQAJgHAAgKQAAgLgJgGQgGgEgLAAIgUAAg");
	this.shape_3.setTransform(61.025,-124.575);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhdBcQglgiAAg6QAAg5AlghQAkgiA5AAQA6AAAlAiQAkAhAAA5QAAA6gkAiQglAhg6AAQg5AAgkghgAglgpQgOAPAAAZQAAAZAOAPQAPAQAWAAQAXAAAOgQQAOgPAAgZQAAgZgOgPQgOgQgXAAQgXAAgOAQg");
	this.shape_4.setTransform(34.525,-124.55);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhTB5IAAjxICnAAIAAA+IhYAAIAAAmIBTAAIAAA9IhTAAIAABQg");
	this.shape_5.setTransform(12.15,-124.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Ctext3, new cjs.Rectangle(0,-142.5,145.9,39), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgeAcQgMgKAAgSQAAgRAMgKQALgKATAAQATAAAMAKQAMALAAAQQAAASgMAKQgMAKgTAAQgTAAgLgKg");
	this.shape.setTransform(166.85,-147.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg5AAIAAg+IDBAAIAAA+Ig6AAIAACzg");
	this.shape_1.setTransform(154.65,-155.825);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgmB5IAAjxIBOAAIAADxg");
	this.shape_2.setTransform(139.3,-155.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhTB5IAAjxICnAAIAAA+IhZAAIAAAmIBUAAIAAA9IhUAAIAABQg");
	this.shape_3.setTransform(124.5,-155.825);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg5AAIAAg+IDBAAIAAA+Ig6AAIAACzg");
	this.shape_4.setTransform(97.95,-155.825);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAhB5IAAhZIhBAAIAABZIhPAAIAAjxIBPAAIAABYIBBAAIAAhYIBPAAIAADxg");
	this.shape_5.setTransform(75.35,-155.825);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhQBeQgngiAAg8QAAg8AoghQAjgeA1AAQAqAAAfASQANAHAQAQIg0AsQgWgVgcAAQgUAAgPAQQgNAQAAAbQAAAbANAQQAPAQAUAAQAZABAHgIIACgCIAAgRIglAAIAAg5IByAAIAABoIgOAMIgQALQgKAHgKAEQgbAKgjAAQg0ABgkgfg");
	this.shape_6.setTransform(49.2,-155.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgnB5IAAjxIBOAAIAADxg");
	this.shape_7.setTransform(30.8,-155.825);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AATB5IgmhRIgKAAIAABRIhPAAIAAjxIBpAAQAsAAAZASQAdAVAAAmQAAAwgoAYIA2BcgAgegSIAUAAQAMAAAFgEQAJgHAAgKQAAgLgJgGQgGgEgLAAIgUAAg");
	this.shape_8.setTransform(14.675,-155.825);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Ctext2, new cjs.Rectangle(0,-173.7,175.2,39), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(57.65,-187.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAhB5IAAhZIhBAAIAABZIhPAAIAAjxIBPAAIAABYIBBAAIAAhYIBPAAIAADxg");
	this.shape_1.setTransform(34.2,-187.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgnB5IAAizIg5AAIAAg+IDBAAIAAA+Ig6AAIAACzg");
	this.shape_2.setTransform(11.65,-187.075);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Ctext1, new cjs.Rectangle(0,-205,69.7,39), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(102.025,-15.05);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231F20").s().p("AgwAvQgSgRgBgeQABgcASgSQAUgRAcAAQAeAAASARQAUASgBAcQABAegUARQgTARgdAAQgcAAgUgRgAgSgUQgIAHABANQgBANAIAIQAHAHALAAQAMAAAIgHQAGgIABgNQgBgNgGgHQgIgJgMAAQgLAAgHAJg");
	this.shape_1.setTransform(86.15,-15.05);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231F20").s().p("AARA+IglhFIABAWIAAAvIgnAAIAAh7IAsAAIAjBEIgCgVIAAgvIApAAIAAB7g");
	this.shape_2.setTransform(72.25,-15.05);
	...
	this.shape_3.setTransform(56.675,-15.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#231F20").s().p("AgvAvQgTgRAAgeQAAgcATgSQASgRAdAAQAeAAATARQASASABAcQgBAegSARQgUARgdAAQgdAAgSgRgAgTgUQgGAHgBANQABANAGAIQAIAHALAAQAMAAAIgHQAGgIAAgNQAAgNgGgHQgIgJgMAAQgLAAgIAJg");
	this.shape_4.setTransform(43.55,-15.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#231F20").s().p("AARA+IAAguIghAAIAAAuIgpAAIAAh7IApAAIAAAtIAhAAIAAgtIAoAAIAAB7g");
	this.shape_5.setTransform(29.8,-15.05);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#231F20").s().p("AgyAvIASgeQAJAHAJADQAKADAFAAQAJAAAAgFQgCgEgHgCIgRgGQgMgFgGgEQgLgJABgRQgBgSAOgMQAOgLAXAAQAaAAARAPIgPAdQgHgGgIgDQgIgDgHAAQgIAAgBAFQAAAEAIACIAGACIAJACQAOAFAGAGQANAJAAARQgBAUgQAMQgOALgVAAQgaAAgXgRg");
	this.shape_6.setTransform(17.95,-15.025);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AobC0QhQAAAAhQIAAjHQAAhQBQAAIQ3AAQBQAAAABQIAADHQAABQhQAAg");
	this.shape_7.setTransform(62,-15.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(0,-33.5,124,36), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(145.975,-188.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhdBbQglghAAg6QAAg4AlgiQAkgiA5AAQA6AAAlAiQAkAiAAA4QAAA6gkAhQglAig6AAQg5AAgkgigAglgpQgOAPAAAaQAAAYAOAPQAPAPAWABQAXgBAOgPQAOgPAAgYQAAgagOgPQgOgQgXAAQgXAAgOAQg");
	this.shape_1.setTransform(119.475,-188.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhjB5IAAjxIBoAAQAsAAAXAUQAcAVAAAqQAAAqgcAVQgXAUgsAAIgZAAIAABLgAgUgNIANAAQAMAAAGgEQAJgGAAgOQAAgNgJgGQgGgEgMAAIgNAAg");
	this.shape_2.setTransform(95.525,-188.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAqB5IgKgiIhDAAIgJAiIhTAAIBUjxIBXAAIBUDxgAAQAaIgRhAIgSBAIAjAAg");
	this.shape_3.setTransform(71.375,-188.275);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgmB5IhajxIBTAAIAtCLIAtiLIBVAAIhbDxg");
	this.shape_4.setTransform(47.95,-188.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AATB5IgmhRIgKAAIAABRIhPAAIAAjxIBpAAQAsAAAZASQAdAVAAAmQAAAwgoAYIA2BcgAgegSIAUAAQAMAAAFgEQAJgHAAgKQAAgLgJgGQgGgEgLAAIgUAAg");
	this.shape_5.setTransform(18.125,-188.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AhXB5IAAjxICrAAIAAA+IhcAAIAAAbIBXAAIAAA9IhXAAIAAAcIBgAAIAAA/g");
	this.shape_6.setTransform(-4.35,-188.275);
	...
	this.shape_7.setTransform(-27.475,-188.075);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAqB5IgKgiIhDAAIgJAiIhTAAIBUjxIBXAAIBUDxgAAQAaIgRhAIgSBAIAjAAg");
	this.shape_8.setTransform(-52.475,-188.275);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhnB5IAAjxIBjAAQAnAAAWAJQAPAGAJANQALAPAAASQAAATgKAPQgKAOgNAGQAUAFANAPQANAPAAAVQAAAkgbASQgYAQgnAAgAgZA+IAZAAQAZAAAAgTQAAgKgHgFQgHgEgLAAIgZAAgAgZgcIAQAAQALAAAFgEQAIgEAAgJQAAgJgIgFQgEgEgMAAIgQAAg");
	this.shape_9.setTransform(-75.8,-188.275);
...
p.nominalBounds = new cjs.Rectangle(-90,-206.2,248.6,39);
...
// stage content:
(lib.fam_300x600_en = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(291).to({_off:false},0).to({alpha:1},22,cjs.Ease.cubicInOut).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(274).to({_off:false},0).to({x:149.05},20,cjs.Ease.quartOut).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({alpha:1},29,cjs.Ease.quartInOut).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(48).to({_off:false},0).to({x:98},20,cjs.Ease.quartOut).wait(169).to({x:-64.5},18,cjs.Ease.quintInOut).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(44).to({_off:false},0).to({x:221},20,cjs.Ease.quartOut).wait(172).to({x:358.5},18,cjs.Ease.quintInOut).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(40).to({_off:false},0).to({x:97},20,cjs.Ease.quartOut).wait(175).to({x:-59.25},18,cjs.Ease.quintInOut).wait(72));

	// cta
	this.instance_6 = new lib.CTA();
	this.instance_6.setTransform(84.45,285.9,1,1,0,0,0,62,18);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(231).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(142).to({_off:false},0).to({x:94.8},22,cjs.Ease.quartOut).wait(65).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(139).to({_off:false},0).to({x:94.8},22,cjs.Ease.quartOut).wait(65).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(81));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(136).to({_off:false},0).to({x:94.8},22,cjs.Ease.quartOut).wait(65).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(133).to({_off:false},0).to({x:94.8},22,cjs.Ease.quartOut).wait(65).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(87));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(22).to({_off:false},0).to({x:110.05},22,cjs.Ease.quartOut).wait(74).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(189));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(19).to({_off:false},0).to({x:110.05},22,cjs.Ease.quartOut).wait(74).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(17).to({_off:false},0).to({x:110.05},22,cjs.Ease.quartOut).wait(74).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(13).to({_off:false},0).to({x:94.8,y:331.8},22,cjs.Ease.quartOut).wait(75).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(197));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(9).to({_off:false},0).to({x:110.05},21,cjs.Ease.quartOut).wait(77).to({startPosition:0},0).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(5).to({_off:false},0).to({x:94.8},21,cjs.Ease.quartOut).wait(78).to({alpha:0},17,cjs.Ease.quartInOut).to({_off:true},4).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_17}]}).wait(325));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fam_300x600_en_atlas_P_1.png", id:"fam_300x600_en_atlas_P_1"},
		{src:"images/fam_300x600_en_atlas_NP_1.jpg", id:"fam_300x600_en_atlas_NP_1"}
	],
	preloads: []
};
