...
lib.ssMetadata = [
		{name:"speed_300x600_us_atlas_P_1", frames: [[0,0,555,1110]]}
];
...
(lib.Asset1tearDBL = function() {
	this.initialize(ss["speed_300x600_us_atlas_P_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.speed_300x600_us = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/speed_300x600_us_atlas_P_1.png", id:"speed_300x600_us_atlas_P_1"}
	],
	preloads: []
};
