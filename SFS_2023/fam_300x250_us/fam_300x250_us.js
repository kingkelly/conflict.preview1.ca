...
lib.ssMetadata = [
		{name:"fam_300x250_us_atlas_P_1", frames: [[0,0,558,1110],[560,251,112,123],[560,0,114,124],[560,126,114,123]]}
];
...
(lib.Asset1 = function() {
	this.initialize(ss["fam_300x250_us_atlas_P_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_5.setTransform(204.3147,-138.7874,0.6899,0.6899);
	...
	this.shape_6.setTransform(182.2376,-138.7874,0.6899,0.6899);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AA5CYIAAh9IhxAAIAAB9IhPAAIAAkvIBPAAIAAB1IBxAAIAAh1IBPAAIAAEvg");
	this.shape_7.setTransform(157.8492,-138.7702,0.6899,0.6899);
	...
	this.shape_8.setTransform(128.0968,-138.7702,0.6899,0.6899);
	...
	this.shape_12.setTransform(247.2272,-194.0493,0.6899,0.6899);
	...
	this.shape_13.setTransform(209.2821,-194.1183,0.6899,0.6899);
	...
	this.shape_14.setTransform(163.0925,-193.5663,0.6899,0.6899);
	...
	this.shape_15.setTransform(113.4707,-194.0838,0.6899,0.6899);
	...
	this.shape_16.setTransform(67.4881,-194.0493,0.6899,0.6899);
	...
	this.shape_17.setTransform(170.1986,-334.2564,0.6899,0.6899);
	...
	this.shape_18.setTransform(177.1322,-296.846,0.6899,0.6899);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231F20").s().p("AgfAsIAAhXIA9AAIAAAXIggAAIAAAJIAfAAIAAAWIgfAAIAAAKIAhAAIAAAXg");
	this.shape.setTransform(86.05,-58.775);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231F20").s().p("AAGAsIgMgdIgEAAIAAAdIgdAAIAAhXIAnAAQAPAAAIAHQAMAHAAAOQAAARgPAJIATAhgAgKgGIAHAAQADAAADgBQACgDAAgEQAAgDgCgDQgDgBgDAAIgHAAg");
	this.shape_1.setTransform(78.5,-58.775);
...
// stage content:
(lib.fam_300x250_us = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(160,281.2,1,1,0,0,0,62,18);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(145).to({y:234.9},23,cjs.Ease.quartInOut).wait(81).to({y:240.9,alpha:0},17,cjs.Ease.quartInOut).to({_off:true},1).wait(76));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/fam_300x250_us_atlas_P_1.png", id:"fam_300x250_us_atlas_P_1"}
	],
	preloads: []
};
